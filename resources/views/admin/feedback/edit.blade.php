            ...
            <div class="row">
                    <div class="col-md-12 col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a class="text-info" href="#">ویرایش بازخورد </a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                <div class="card">
                   <div class="card-header">
                       <h1 class="h4">ویرایش بازخورد </h1>
                   </div>
                   <div class="card-body">
                        <form method="POST" action="{{route('admin.feedback.update',['id' => $item->id])}}" enctype="multipart/form-data">
                            @csrf
                            @method('post')
                            <div class="form-group row">
                               <label for="name" class="col-md-4 col-form-label label-form"> نام مشتری </label>
                               <div class="col-md-12">
                                    <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }} contact-form" name="name" value="{{ old('name',$item->name) }}">
                                        @if ($errors->has('name'))
                            ...
                            <div class="form-group row">
                               ...
                               <div class="col-md-12">
                                   <textarea class="form-control" name="comment" id="comment" cols="30" rows="5" >{{ old('comment',$item->comment) }}</textarea>
