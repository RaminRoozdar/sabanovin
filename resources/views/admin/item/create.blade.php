                   ...
                   <div class="card-body">
                        <form method="POST" action="{{route('admin.item.store')}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                               ...
                               <div class="col-md-12">
                                    <input id="slug" type="text" dir="ltr" class="form-control{{ $errors->has('slug') ? ' is-invalid' : '' }} contact-form" name="slug" value="{{ old('slug') }}" required>
                                        @if ($errors->has('slug'))
                                            <span class="invalid-feedback">
                            ...
                            <div class="form-group row">
                               ...
                               <div class="col-md-12" dir="rtl">
                                    <textarea class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" id="full-featured-non-premium">{{ old('description') }}</textarea>
                            ...
                            <div class="form-group row">
                                <label for="image" class="col-md-4 col-form-label label-form"> تصویر خبر</label>
                                <div class="col-md-12">
