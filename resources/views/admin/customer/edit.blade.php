            ...
            <div class="row">
                    <div class="col-md-12 col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a class="text-dark" href="{{ route('admin.customer') }}">مشتریان</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><a class="text-info" href="#">ویرایش مشتری </a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                <div class="card">
                   <div class="card-header">
                       <h1 class="h4">ویرایش مشتری </h1>
                   </div>
                   <div class="card-body">
                        <form method="POST" action="{{route('admin.customer.update',['id'=>$item->id])}}" enctype="multipart/form-data">
                            @csrf
                            @method('post')
                            ...
                            <div class="form-group row">
                               <label for="link" class="col-md-4 col-form-label label-form"> آدرس مشتری</label>
                               <div class="col-md-12">
