  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">   آپلود تصاویر </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
           <form action="{{ route('admin.uploader.store') }}" method="post" enctype="multipart/form-data">
            @Csrf
            @method('post')
            <div class="col-md-12 form-group row">
                <div class="col-md-12">
                    <label for="operator"> عنوان تصویر : </label>
                </div>
                <div class="col-md-12">
            ...
            <div class="col-md-12 form-group row">
                <div class="col-md-12">
                    <label for="source">  انتخاب تصویر : </label>
                </div>
                <div class="col-md-12">
