            ...
            <div class="row">
                ...
                <div class="card">
                   <div class="card-header">
                       <h1 class="h4">ایجاد اخبار جدید</h1>
                   </div>
                   <div class="card-body">
                        <form method="POST" action="{{route('admin.item.update',['id' => $item->id])}}" enctype="multipart/form-data">
                            @csrf
                            @method('post')
                            <div class="form-group row">
                               <label for="title" class="col-md-4 col-form-label label-form">عنوان خبر</label>
                               <div class="col-md-12">
                            ...
                            <div class="form-group row">
                               ...
                               <div class="col-md-12">
                                    <input id="slug" type="text" dir="ltr" class="form-control{{ $errors->has('slug') ? ' is-invalid' : '' }} contact-form" name="slug" value="{{ old('slug',$item->slug) }}" required>
                                        @if ($errors->has('slug'))
                                            <span class="invalid-feedback">
                            ...
                            <div class="form-group row">
                               <label for="description" class="col-md-4 col-form-label label-form">محتوای خبر</label>
                               <div class="col-md-12" dir="rtl">
                                    <textarea class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" id="full-featured-non-premium">{!! $item->description !!}</textarea>
