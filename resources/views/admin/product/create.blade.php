        ...
        <div class="col-md-9">
            <div class="card">
                <div class="card-header">
                    <h1 class="h4">ایجاد محصول جدید</h1>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{route('admin.product.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                 <input id="count" type="number" class="form-control{{ $errors->has('count') ? ' is-invalid' : '' }} contact-form" name="count" value="{{ old('count') }}">
                                     @if ($errors->has('count'))
                                         <span class="invalid-feedback">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <div class="input-group mb-2 ml-sm-2">
                                    <input id="amount" type="text" dir="ltr" class="price form-control{{ $errors->has('amount') ? ' is-invalid' : '' }}" name="amount" value="{{ old('amount') }}" required>
