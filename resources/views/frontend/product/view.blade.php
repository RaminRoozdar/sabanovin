			  ...
			  <div class="col-md-10">
			      <div class="page-context blog-context blog-compact-context">
                                            ...
                                            @foreach(session('cart') as $id => $details)
                                                <div class="row cart-detail">
                                                    <div class="col-lg-4 col-sm-4 col-4 cart-detail-img">
                                                        <img width="85px" height="85px" src="{{ $details['image'] }}" />
                                                    </div>
                      ...
                      <div class="col-md-12 row bg-white mt-5 justify-content-center">
                          <div class="col-md-6">
                            <img height="250" class="card-img-top mb-2" src="{{ $product->image }}" alt="image">
                          </div>
                          <div class="col-md-6">
                            ...
                            <div class="owl-costumer owl-carousel owl-theme col-md-12 row bg-white mt-5 justify-content-center">
                                ...
                                @foreach ($products as $product)
                                       <div class="item border border-warning rounded m15">
                                             ...
                                             <a href="{{ route('product.view',['id'=>$product->id]) }}"><img class="p-2" width="100" height="150" src="{{ $product->image }}" alt="{{ $product->title }}" ></a>
