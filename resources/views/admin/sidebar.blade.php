<div class="list-group mb-2 d-none d-md-block d-lg-block d-xl-block">
    <a class="list-group-item list-group-item-action{{ Request::segment(2) == 'dashboard' ? ' active' : '' }}" href="{{ route('admin.dashboard') }}"><i class="fa fa-cogs"></i> پنل مدیریت</a>
    <a class="list-group-item list-group-item-action{{ Request::segment(1) == 'dashboard' ? ' active' : '' }}" href="{{ route('dashboard') }}"><i class="fa fa-dashboard"></i> پنل کاربری</a>
    ...
    <a class="list-group-item list-group-item-action{{ Request::segment(2) == 'page' ? ' active' : '' }}" href="{{route('admin.page')}}"><i class="fa fa-files-o"></i> صفحه ها </a>
...
<div class="nav-scroller d-block d-md-none d-lg-none d-xl-none mb-2 border">
    <nav class="nav nav-underline">
        <a class="nav-link{{ Request::segment(2) == 'dashboard' ? ' active' : '' }}" href="{{ route('admin.dashboard') }}"><i class="fa fa-cogs"></i> پنل مدیریت</a>
        <a class="nav-link{{ Request::segment(1) == 'dashboard' ? ' active' : '' }}" href="{{ route('dashboard') }}"><i class="fa fa-dashboard"></i> پنل کاربری</a>
        ...
        <a class="nav-link{{ Request::segment(2) == 'page' ? ' active' : '' }}" href="{{route('admin.page')}}"><i class="fa fa-files-o"></i> صفحه ها </a>
